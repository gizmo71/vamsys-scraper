const airlines = {
    ...
    "9": {
        "name": "Eurowings",
        "rank_info": "Bonus points not included in normal points total\nSenior First Officer:\n\t+387.1 Hours (216.0 PIREPs)\n\t+28683.0 Points (193.9 PIREPs)\nCaptain:\n\t+887.1 Hours (494.9 PIREPs)\n\t+66683.0 Points (450.9 PIREPs)\n\t+14487.0 Bonus Points (58.8 PIREPs)\nSenior Captain:\n\t+1387.1 Hours (773.9 PIREPs)\n\t+104683.0 Points (707.8 PIREPs)\n\t+29487.0 Bonus Points (119.7 PIREPs)\nInstructor:\n\t+4887.1 Hours (2726.6 PIREPs)\n\t+370683.0 Points (2506.5 PIREPs)\nFlying Legend:\n\t+9887.1 Hours (5516.2 PIREPs)\n\t+752683.0 Points (5089.5 PIREPs)\nTime mode: air",
        "requirements": "1 PIREP(s) required over 180 days\nNext 1 PIREP(s) required by 2024-04-28",
        "sortName": "Eurowings"
    },
    "13": {
        "name": "vTCXgroup",
    ...
    "30": {
        "name": "Aer Lingus",
        "rank_info": "First Officer:\n\t+13.6 Hours (9.9 PIREPs)\n\t+1825.0 Points (8.2 PIREPs)\nSenior First Officer:\n\t+83.6 Hours (61.1 PIREPs)\n\t+9325.0 Points (41.8 PIREPs)\n\t+1000.0 Bonus Points\nCaptain:\n\t+283.6 Hours (207.4 PIREPs)\n\t+27325.0 Points (122.6 PIREPs)\n\t+4000.0 Bonus Points\nSenior Captain (TRE/TRI/Line):\n\t+883.6 Hours (646.1 PIREPs)\n\t+72325.0 Points (324.4 PIREPs)\n\t+12000.0 Bonus Points\nBase Chief Pilot:\n\t+1483.6 Hours (1084.9 PIREPs)\n\t+127325.0 Points (571.2 PIREPs)\n\t+20000.0 Bonus Points\nTime mode: air",
        "requirements": "1 PIREP(s) required over 30 days\nNext 1 PIREP(s) required by 2023-12-04",
        "sortName": "Linugs"
    },
    "35": {
    ...
    "46": {
        "name": "United",
        "rank_info": "Bonus points count towards normal points total\nFirst Officer:\n\t+14.6 Hours (13.6 PIREPs)\n\t+875.0 Points (3.9 PIREPs)\nSenior First Officer:\n\t+34.6 Hours (32.3 PIREPs)\n\t+4875.0 Points (21.7 PIREPs)\nCaptain:\n\t+94.6 Hours (88.2 PIREPs)\n\t+8875.0 Points (39.4 PIREPs)\n\t+750.0 Bonus Points (15.0 PIREPs)\nBase Captain:\n\t+144.6 Hours (134.7 PIREPs)\n\t+13875.0 Points (61.7 PIREPs)\n\t+1250.0 Bonus Points (25.0 PIREPs)\nChief Pilot:\n\t+294.6 Hours (274.5 PIREPs)\n\t+28875.0 Points (128.3 PIREPs)\n\t+1750.0 Bonus Points (35.0 PIREPs)\nTime mode: block",
        "sortName": "United"
    },
    "55": {
        "name": "Spirit",
    ...
    "265": {
        "name": "Air China",
        "rank_info": "Bonus points not included in normal points total\nSecond Officer / \u7b2c\u4e8c\u526f\u9a7e\u9a76:\n\t+38.0 Hours (25.4 PIREPs)\n\t+3205.0 Points (32.3 PIREPs)\nFirst Officer / \u7b2c\u4e00\u526f\u9a7e\u9a76:\n\t+138.0 Hours (92.3 PIREPs)\n\t+13205.0 Points (132.9 PIREPs)\nSenior First Officer / \u8d44\u6df1\u526f\u9a7e\u9a76:\n\t+288.0 Hours (192.6 PIREPs)\n\t+26705.0 Points (268.7 PIREPs)\nCaptain / \u673a\u957f:\n\t+588.0 Hours (393.3 PIREPs)\n\t+59205.0 Points (595.8 PIREPs)\nTraining Captain / \u98de\u884c\u6559\u5458:\n\t+988.0 Hours (660.8 PIREPs)\n\t+99205.0 Points (998.3 PIREPs)\nFleet Captain / \u98de\u884c\u5927\u961f\u961f\u957f:\n\t+1988.0 Hours (1329.6 PIREPs)\n\t+199205.0 Points (2004.6 PIREPs)\nTime mode: block",
        "sortName": "China"
    },
    "291": {
        "name": "JetBlue",
        "rank_info": "Bonus points count towards normal points total\nFirst Officer:\n\t+41.5 Hours (43.8 PIREPs)\n\t+2075.0 Points (9.7 PIREPs)\nSenior First Officer:\n\t+191.5 Hours (202.1 PIREPs)\n\t+15075.0 Points (70.5 PIREPs)\nCaptain:\n\t+491.5 Hours (518.7 PIREPs)\n\t+43075.0 Points (201.4 PIREPs)\nTraining Captain:\n\t+991.5 Hours (1046.4 PIREPs)\n\t+78075.0 Points (365.0 PIREPs)\nSenior Training Captain:\n\t+1491.5 Hours (1574.2 PIREPs)\n\t+128075.0 Points (598.8 PIREPs)\nChief Pilot:\n\t+2491.5 Hours (2629.6 PIREPs)\n\t+248075.0 Points (1159.8 PIREPs)\nTime mode: block",
        "sortName": "JetBlue"
    },
    "356": {
        "name": "Dan Air",
        "rank_info": "Senior Captain:\n\t+161.6 Hours (89.2 PIREPs)\nBase Captain:\n\t+776.6 Hours (428.5 PIREPs)\nChief Pilot:\n\t+2096.6 Hours (1156.7 PIREPs)\nTime mode: air",
        "sortName": "Dan Air"
    },
    "500": {
        "name": "Titan",
    ...
    "1005": {
        "name": "All Nippon",
        "rank_info": "Bonus points not included in normal points total\nSecond Officer:\n\t+41.2 Hours (37.5 PIREPs)\n\t+3503.0 Points (56.4 PIREPs)\nFirst Officer:\n\t+141.2 Hours (128.4 PIREPs)\n\t+13503.0 Points (217.4 PIREPs)\nSenior First Officer:\n\t+291.2 Hours (264.9 PIREPs)\n\t+27003.0 Points (434.7 PIREPs)\nCaptain:\n\t+591.2 Hours (537.8 PIREPs)\n\t+59503.0 Points (957.8 PIREPs)\nTraining Captain:\n\t+991.2 Hours (901.7 PIREPs)\n\t+99503.0 Points (1601.7 PIREPs)\nBase Captain:\n\t+1991.2 Hours (1811.3 PIREPs)\n\t+199503.0 Points (3211.3 PIREPs)\nTime mode: air",
        "sortName": "Nippon"
    },
    "1033": {
        "name": "Delta",
    ...
    "1309": {
        "name": "Allegiant",
        "rank_info": "Trainee:\n\t+0.4 Hours (0.4 PIREPs)\nTrainee Second Officer:\n\t+13.4 Hours (16.3 PIREPs)\n\t+2560.0 Points (11.6 PIREPs)\nSecond Officer:\n\t+38.4 Hours (46.7 PIREPs)\n\t+7560.0 Points (34.4 PIREPs)\nSenior Second Officer:\n\t+63.4 Hours (77.1 PIREPs)\n\t+12560.0 Points (57.1 PIREPs)\nTrainee First Officer:\n\t+88.4 Hours (107.6 PIREPs)\n\t+19560.0 Points (88.9 PIREPs)\nFirst Officer:\n\t+113.4 Hours (138.0 PIREPs)\n\t+24560.0 Points (111.6 PIREPs)\nSenior First Officer:\n\t+138.4 Hours (168.5 PIREPs)\n\t+29560.0 Points (134.4 PIREPs)\nCaptain:\n\t+163.4 Hours (198.9 PIREPs)\n\t+34560.0 Points (157.1 PIREPs)\nJunior Training Captain:\n\t+188.4 Hours (229.4 PIREPs)\n\t+39560.0 Points (179.8 PIREPs)\nTraining Captain:\n\t+213.4 Hours (259.8 PIREPs)\n\t+44560.0 Points (202.5 PIREPs)\nSenior Training Captain:\n\t+238.4 Hours (290.2 PIREPs)\n\t+49560.0 Points (225.3 PIREPs)\nTime mode: air",
        "sortName": "Allegiant"
    }
};