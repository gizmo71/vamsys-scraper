const airlines = {
    ...
    "30": {
        ...
        "name": "Aer Lingus",
        "rank_info": "First Officer:\n\t+2.6 Hours (1.8 PIREPs)\n\t+235.0 Points (1.0 PIREPs)\nSenior First Officer:\n\t+72.6 Hours (50.3 PIREPs)\n\t+7735.0 Points (34.5 PIREPs)\nCaptain:\n\t+272.6 Hours (189.0 PIREPs)\n\t+25735.0 Points (114.6 PIREPs)\n\t+2000.0 Bonus Points (19.0 PIREPs)\nSenior Captain (TRE/TRI/Line):\n\t+872.6 Hours (604.9 PIREPs)\n\t+70735.0 Points (315.1 PIREPs)\n\t+10000.0 Bonus Points (95.0 PIREPs)\nBase Chief Pilot:\n\t+1472.6 Hours (1020.8 PIREPs)\n\t+125735.0 Points (560.1 PIREPs)\n\t+18000.0 Bonus Points (171.0 PIREPs)\nTime mode: air",
        "requirements": "1 PIREP(s) required over 30 days\nNext 1 PIREP(s) required by 2024-02-07",
        "sortName": "Linugs"
    },
    "35": {
        "callsigns": [
    ...
    "46": {
        ...
        "name": "United",
        "rank_info": "Bonus points count towards normal points total\nFirst Officer:\n\t+12.0 Hours (10.6 PIREPs)\n\t+98.0 Points (0.4 PIREPs)\nSenior First Officer:\n\t+32.0 Hours (28.2 PIREPs)\n\t+4098.0 Points (15.1 PIREPs)\nCaptain:\n\t+92.0 Hours (80.9 PIREPs)\n\t+8098.0 Points (29.8 PIREPs)\n\t+350.0 Bonus Points (3.8 PIREPs)\nBase Captain:\n\t+142.0 Hours (124.9 PIREPs)\n\t+13098.0 Points (48.2 PIREPs)\n\t+850.0 Bonus Points (9.2 PIREPs)\nChief Pilot:\n\t+292.0 Hours (256.8 PIREPs)\n\t+28098.0 Points (103.4 PIREPs)\n\t+1350.0 Bonus Points (14.5 PIREPs)\nTime mode: block",
        "sortName": "United"
    },
    "55": {
        "callsigns": [
    ...
    "227": {
        ...
        "name": "Qatar",
        "rank_info": "Bonus points count towards normal points total\nSecond Officer:\n\t+47.0 Hours (46.2 PIREPs)\n\t+2220.0 Points (8.5 PIREPs)\n\t+50.0 Bonus Points (1.0 PIREPs)\nFirst Officer:\n\t+197.0 Hours (194.0 PIREPs)\n\t+4220.0 Points (16.2 PIREPs)\n\t+1350.0 Bonus Points (27.0 PIREPs)\nSenior First Officer:\n\t+397.0 Hours (390.9 PIREPs)\n\t+8220.0 Points (31.6 PIREPs)\n\t+1850.0 Bonus Points (37.0 PIREPs)\nCaptain:\n\t+597.0 Hours (587.9 PIREPs)\n\t+11220.0 Points (43.2 PIREPs)\n\t+3350.0 Bonus Points (67.0 PIREPs)\nTraining Captain:\n\t+997.0 Hours (981.9 PIREPs)\n\t+99220.0 Points (381.6 PIREPs)\n\t+3850.0 Bonus Points (77.0 PIREPs)\nBase Captain:\n\t+1997.0 Hours (1966.7 PIREPs)\n\t+199220.0 Points (766.2 PIREPs)\n\t+4850.0 Bonus Points (97.0 PIREPs)\nTime mode: block",
        "requirements": "1 PIREP(s) required over 30 days\nNext 1 PIREP(s) required by 2024-02-01",
        "sortName": "Qatar"
    },
    "265": {
        "callsigns": [
    ...
    "500": {
        ...
        "name": "Titan",
        "rank_info": "Bonus points not included in normal points total\nSecond Officer:\n\t+33.8 Hours (14.6 PIREPs)\n\t+2109.0 Points (7.8 PIREPs)\nFirst Officer:\n\t+133.8 Hours (57.9 PIREPs)\n\t+12109.0 Points (44.8 PIREPs)\nSenior First Officer:\n\t+283.8 Hours (122.8 PIREPs)\n\t+25609.0 Points (94.8 PIREPs)\nCaptain:\n\t+583.8 Hours (252.5 PIREPs)\n\t+58109.0 Points (215.1 PIREPs)\nTraining Captain:\n\t+983.8 Hours (425.5 PIREPs)\n\t+98109.0 Points (363.2 PIREPs)\nBase Captain:\n\t+1983.8 Hours (858.1 PIREPs)\n\t+198109.0 Points (733.3 PIREPs)\nTime mode: block",
        "sortName": "Titan"
    },
    "550": {
        "callsigns": [
